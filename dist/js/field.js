...
Nova.booting(function (Vue, router) {
    Vue.component('index-nova-multiline-text', __webpack_require__(5));
    Vue.component('detail-nova-multiline-text', __webpack_require__(11));
});
    ...
    _vm._l(_vm.field.value, function(item, index) {
      return _c("li", { key: item }, [
        _c(
          ...
          {
            class: {
              highlight: _vm.field.highlightFirst === true && index === 0
            }
          },
          [_vm._v(_vm._s(item))]
        )
